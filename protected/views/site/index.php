...
<div style="position:relative; left:20px; top:35px; width:603px; height:434px; background:url('/images/HAM-UI_06.png') no-repeat center;">
  ...
  <div style="position:relative; top:-28px; left:167px; width:126px; height:28px; padding-left:20px; padding-top:0px; font-weight:bold; background: url('/images/RightBtnOn.png') no-repeat top left;">
